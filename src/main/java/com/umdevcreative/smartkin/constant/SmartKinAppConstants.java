package com.umdevcreative.smartkin.constant;
...
public final class SmartKinAppConstants {
    public static final String ENTITY_PACKAGE = "com.umdevcreative.smartkin.jpa.entity";
    public static final String REPOSITORY_PACKAGE = "com.umdevcreative.smartkin.jpa.repository";
